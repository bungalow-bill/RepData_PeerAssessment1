...
I used the latest version of Rstudio and rmarkdown to prepare this assignment.  There are certainly some benefits to doing this, but one issue is that the supporting files generated by knitr::markdown2html are placed in a deeper folder structure.  Rather than /figure, you will find all of the figures in the /PA1_template_files/figure-html folder.
